        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-2xl overflow-hidden aspect-video md:aspect-square relative group">
              <Image src="/gym_gallery_cardio.png" alt="Cardio Section" fill className="object-cover transition-transform duration-700 group-hover:scale-110" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-6">
                <span className="font-bold text-lg text-white">Advanced Cardio</span>
              </div>
            </div>
            <div className="rounded-2xl overflow-hidden aspect-video md:aspect-square relative group">
              <Image src="/gym_gallery_weights.png" alt="Free Weights" fill className="object-cover transition-transform duration-700 group-hover:scale-110" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-6">
                <span className="font-bold text-lg text-white">Free Weights Area</span>
              </div>
            </div>
            <div className="rounded-2xl overflow-hidden aspect-video md:aspect-square relative group">
              <Image src="/gym_gallery_studio.png" alt="Studio" fill className="object-cover transition-transform duration-700 group-hover:scale-110" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-6">
